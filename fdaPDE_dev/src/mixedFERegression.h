...
class MixedFERegressionBase
{
	...
	*/
	...
	static void computeRegressionSolution(const std::vector<VectorXr>& solution,const InputHandler& regressionData ,std::vector<VectorXr>&  fn_hat ,std::vector<VectorXr>&  beta_hat);
